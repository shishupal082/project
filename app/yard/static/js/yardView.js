...
tableContent[0].push("");
tableContent[0].push("");
tableContent[0].push($YM.getTableHtml(yardComponent, "left-top"));
tableContent[0].push($YM.getTableHtml(yardComponent, "8-point-top"));
tableContent[0].push($YM.getTableHtml(yardComponent, "s14-tpr"));
tableContent[0].push($YM.getTableHtml(yardComponent, "l-tpr-1"));
tableContent[0].push($YM.getTableHtml(yardComponent, "l-tpr-2"));
tableContent[0].push($YM.getTableHtml(yardComponent, "s2-tpr"));
tableContent[0].push($YM.getTableHtml(yardComponent, "right-top"));
tableContent.push([]);
tableContent[1].push("");
tableContent[1].push("");
tableContent[1].push("");
tableContent[1].push($YM.getTableHtml(yardComponent, "8-point-mid"));
tableContent[1].push("");
tableContent[1].push("");
tableContent[1].push("");
tableContent[1].push($YM.getTableHtml(yardComponent, "9-point-mid-1"));
tableContent[1].push($YM.getTableHtml(yardComponent, "9-point-mid"));
tableContent.push([]);
tableContent[2].push($YM.getTableHtml(yardComponent, "1-tpr"));
tableContent[2].push($YM.getTableHtml(yardComponent, "16-tpr"));
tableContent[2].push($YM.getTableHtml(yardComponent, "8-tpr"));
tableContent[2].push($YM.getTableHtml(yardComponent, "8c-tpr"));
tableContent[2].push($YM.getTableHtml(yardComponent, "s15-tpr"));
tableContent[2].push($YM.getTableHtml(yardComponent, "m-tpr-1"));
tableContent[2].push($YM.getTableHtml(yardComponent, "m-tpr-2"));
tableContent[2].push($YM.getTableHtml(yardComponent, "s3-tpr"));
tableContent[2].push($YM.getTableHtml(yardComponent, "9d-tpr"));
tableContent[2].push($YM.getTableHtml(yardComponent, "9-tpr"));
tableContent[2].push($YM.getTableHtml(yardComponent, "4-tpr"));
tableContent.push([]);
tableContent[3].push("");
tableContent[3].push("");
tableContent[3].push("");
tableContent[3].push("");
tableContent[3].push("");
// tableContent[3].push($YM.getTableHtml("tc"));

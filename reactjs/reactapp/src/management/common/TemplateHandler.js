...
Template.extend({
    updateTemplateValue: function(template, values) {
        return TemplateHelper.updateTemplateValue(template, values);
    },
    replaceTextPattern: function(template, fieldName, patternValue) {
        return TemplateHelper.replaceTextPattern(template, fieldName, patternValue);
    },
    setTemplateTextByFormValues: function(template, formValues) {
        return TemplateHelper.updateTemplateText(template, formValues);
    },
